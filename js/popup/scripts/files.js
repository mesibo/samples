...
let sendFile = (pFileType, pFileurl, pThumbnail) => {
	...
	var p = {
		'id': mid
		, 'peer': MesiboDemoApp.getStorage().getNumberFromName(DOM.messageAreaName.innerHTML)
		, 'gid': 0
		, 'channel': 0
	...
	p = {};
	p.peer = MesiboDemoApp.getStorage().getNumberFromName(DOM.messageAreaName.innerHTML);
